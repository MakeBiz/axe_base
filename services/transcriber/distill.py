...
AGENTS={
 ...
 'yasna': dict(d='/root/.openclaw/agents/yasna/agent/codex-home/sessions',
 env='/root/.secrets/yasna_mem.env', table='yasna.memory', col='content',
 cols=('topic','content','source'),
 prompt='Ты ведёшь долгую память бизнес-коуча о Злате. Из диалога вытащи только устойчивые переиспользуемые факты о Злате, её психологическом методе и экспертизе, её продукте и упаковке, целевой аудитории, договорённостях, целях по монетизации и прогрессе. Без воды и общих фраз. От 0 до 8 пунктов, каждый одной короткой строкой, без нумерации и маркеров. Если ничего стоящего нет, верни пусто.'),
}
